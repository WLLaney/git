//
//  CSDrawerControllerViewController.m
//  YjY
//
...
typedef NS_ENUM(NSUInteger, CSDrawerControllerState)
{
...
@interface CSDrawerControllerViewController () <UIGestureRecognizerDelegate>

@property(nonatomic, strong, readwrite) UIViewController<CSDrawerControllerChild, CSDrawerControllerPresenting> *leftViewController;
@property(nonatomic, strong, readwrite) UIViewController<CSDrawerControllerChild, CSDrawerControllerPresenting> *centerViewController;

@property(nonatomic, strong) UIView *leftView;
@property(nonatomic, strong) CSDropShadowView *centerView;

@property(nonatomic, strong) UITapGestureRecognizer *tapGestureRecognizer;
@property(nonatomic, strong) UIPanGestureRecognizer *panGestureRecognizer;
@property(nonatomic, assign) CGPoint panGestureStartLocation;

@property(nonatomic, assign) CSDrawerControllerState drawerState;


@end

@implementation CSDrawerControllerViewController
...
- (void)viewDidLoad {
    ...
    self.centerView = [[CSDropShadowView alloc] initWithFrame:self.view.bounds];
